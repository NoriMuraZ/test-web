...
import { Package, Users, Folder, TrendingUp, AlertCircle, Clock, UserCog } from 'lucide-react';
import StatsCard from './StatsCard';
import { mockProducts, mockCustomers, mockCategories, mockUsers } from '../../data/mockData';
...
const Dashboard: React.FC = () => {
  ...
  const recentActivity = [
    ...
    { id: 4, action: 'カテゴリ「電子機器」が変更されました', time: '1日前', type: 'update' },
    { id: 5, action: '商品「オフィスチェア」が無効化されました', time: '2日前', type: 'delete' },
    { id: 6, action: '在庫アラート：ノートパソコンの在庫が少なくなっています', time: '3日前', type: 'warning' },
  ];
